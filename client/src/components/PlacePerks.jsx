...
const PerkButton = ({ title, iconPath, handleClick, checked = false }) => {
  return (
...
export const PlacePerks = ({ selected, onChange }) => {
  ...
  return (
    <PlaceInput header={"Perks"} description={"select all the perks"}>
      <div className="grid mt-2 gap-2 grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
        ...
        <PerkButton
          ...
          handleClick={handleChange}
          checked={selected.includes("Cinema")}
        />

        <PerkButton
          title={"Private enterence"}
          iconPath={
          ...
          handleClick={handleChange}
          checked={selected.includes("Private enterence")}
        />
      </div>
    </PlaceInput>
  );
